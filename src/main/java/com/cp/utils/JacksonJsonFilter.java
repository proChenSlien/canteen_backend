...
public class JacksonJsonFilter extends FilterProvider {
    ...
    public static String toStringEx( Object bean, String[] exclude) throws JsonProcessingException {
        ObjectMapper mapper = JsonMapper.nonEmptyMapper().getMapper();
        JacksonJsonFilter jacksonFilter = new JacksonJsonFilter();
        jacksonFilter.filter(bean.getClass(), exclude);
        mapper.setFilterProvider(jacksonFilter);
        mapper.addMixIn(bean.getClass(), jacksonFilter.getClass());
        return  mapper.writeValueAsString(bean);
    }
    public static String toStringIn( Object bean, String[] include) throws JsonProcessingException {
        ObjectMapper mapper = JsonMapper.nonEmptyMapper().getMapper();
        JacksonJsonFilter jacksonFilter = new JacksonJsonFilter();
        jacksonFilter.include(bean.getClass(), include);
        mapper.setFilterProvider(jacksonFilter);
        mapper.addMixIn(bean.getClass(), jacksonFilter.getClass());
        return  mapper.writeValueAsString(bean);
    }
