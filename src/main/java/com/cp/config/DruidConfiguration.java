...
//        registrationBean.addInitParameter("allow", "127.0.0.1");
        ...
        registrationBean.addInitParameter("loginPassword", "liufeng");
    ...
    public DataSource druidDataSource(@Value("${spring.datasource.url}") String url,
        ...
        try {
            ...
            e.printStackTrace();
            logger.error("Druid数据源filters设置失败......");
        }
        return dataSource;
    }
    ...
    public JdkRegexpMethodPointcut druidStatPointcut(){
        ...
        String patterns = "com.sj.service.*";
//        String patterns2 = "com.sj.controller.*";
